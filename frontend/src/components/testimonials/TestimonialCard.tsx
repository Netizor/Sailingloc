...
import { pickLocale, type Testimonial } from '../../data/testimonials'
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="text-[11px] font-medium text-gray-400 dark:text-gray-500">{pickLocale(item.date, lang)}</span>
      </div>

      <p className="text-brand-slate dark:text-gray-300 text-sm leading-relaxed flex-1">
        &ldquo;{pickLocale(item.text, lang)}&rdquo;
      </p>
      ...
      <div className="space-y-2 pt-1 border-t border-gray-50 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-brand-slate dark:text-gray-400">{pickLocale(item.role, lang)}</p>
          </div>
        </div>
