            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="mt-5 flex items-center gap-3">
                ...
                <button
                  type="button"
                  onClick={() => accept(true)}
                  className="flex-1 px-4 py-3 text-sm font-semibold text-white bg-[#2563FF] hover:bg-[#3B82F6] rounded-xl transition-colors"
                >
            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="flex gap-2">
                ...
                <button
                  type="button"
                  onClick={saveCustom}
                  className="flex-1 px-4 py-2.5 text-sm font-semibold text-white bg-[#2563FF] hover:bg-[#3B82F6] rounded-xl transition-colors"
                >
